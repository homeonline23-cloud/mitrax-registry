...
# --- 2. IMPERIAL STYLING (THE SHIELDED VAULT) ---
st.markdown("""
    <style>
    .stApp { background-color: #0E1117; color: #FFFFFF; }
    
    /* Pulsing Imperial Shield & Pyramid */
    @keyframes goldPulse {
...
# --- 3. THE IMPERIAL SHIELD & PYRAMID INJECTOR ---
# Replaced the compass with the requested Shield and Golden Pyramid
st.markdown("""
...
# --- PHASE 4: REGISTRATION ---
    ...
    st.markdown("<div class='vault-header'>🛡️ THE MITRAX VAULT 📐</div>", unsafe_allow_html=True)
...
# --- PHASE 5: SECTOR 2 - THE CALCULATOR ---
    ...
    st.write(f"Welcome, Commander {st.session_state.get('user_name', 'Soldier')}. Vault verification complete.")
