...
# --- PHASE 3: WELCOME & INSTALL ---
    ...
    st.markdown("<div style='background-color:#1A1A1A; padding:20px; border-radius:15px; border:1px solid #333;'><h3>Install the Mitrax App Icon on your phone!</h3><p>Android: 3 Dots -> Install App | iPhone: Share -> Add to
