...
# --- 1. THE IMPERIAL ENGINE CONFIG (V30 ABSOLUTE LOCK) ---
st.set_page_config(layout="wide", page_title="MITRAX ORACLE V30")
...
st.markdown("""
    ...
    /* --- THE V30 ABSOLUTE ALIGNMENT LOCK --- */
    .v30-command-center {
        display: flex !important;
        flex-direction: column !important;
        align-items: center !important; /* FORCED CENTER */
        justify-content: flex-start !important;
        width: 100% !important;
        margin-top: -140px !important; /* LIFTED HIGHER */
        position: relative !important;
        z-index: 9999 !important;
    }

    /* THE GOLDEN PILLAR - LOCKED IN CENTER */
    .v30-pillar { 
        background-color: #D4AF37 !important; 
        width: 28px !important; 
        height: 320px !important; 
        margin: 0 auto !important; /* CENTERED AUTO MARGIN */
    ...
    .v30-label { color: #D4AF37 !important; font-weight: 900 !important; font-size: 26px !important; text-transform: uppercase !important; margin-bottom: 30px !important; text-align: center !important; }

    /* THE ENTRY WINDOWS - V30 CENTER LOCK */
    ...
    .v30-bridge { color: #00FF00 !important; font-size: 38px !important; font-weight: 900 !important; border-bottom: 8px solid #00FF00 !important; margin-bottom: 160px !important; text-align: center !important; }
    .v30-spacer { height: 250px !important; width: 100%; }
    </style>
...
if os.path.exists("mitrax_banner.jpg"):
    ...
    st.markdown("<h1 style='color:#D4AF37; text-align:center;'>MITRAX ORACLE V30</h1>", unsafe_allow_html=True)

# --- 3. THE WINNING BOARD ---
st.markdown("<div class='v30-board'>", unsafe_allow_html=True)
...
st.markdown("<div class='v30-bridge'>SYMMETRY MATRIX SENSORS</div>", unsafe_allow_html=True)
