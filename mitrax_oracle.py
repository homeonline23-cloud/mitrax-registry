...
st.markdown("""
    ...
    .island-mini { color: #D4AF37; font-size: 10px; font-weight: 900; margin: 0; line-height: 1; }
    .num-mini { color: #00FF00; font-size: 14px; font-weight: 900; margin: 0; line-height: 1; }

    /* HIGH-DENSITY GRID LAYOUT */
    .gold-pillar { background-color: #D4AF37; width: 6px; height: 140px; margin: 0 auto; border-radius: 3px; }
    .matrix-cell { 
        font-weight: 900; font-size: 15px; border: 1px solid #000000; 
        aspect-ratio: 1/1; display: flex; align-items: center; justify-content: center; 
        border-radius: 3px; margin: 1px; color: #000000; height: 32px; width: 32px;
    }
    .red-target { border: 2px solid #FF0000; border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; }
    .blue-target { border: 2px solid #0000FF; border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; }
    
    .grid-light { background-color: #D3D3D3 !important; }
    .grid-dark { background-color: #707070 !important; }
    .island-label { color: #D4AF37; font-weight: 900; font-size: 11px; text-transform: uppercase; margin-bottom: 1px; }

    .stTextInput > div > div > input { 
        background-color: #FFFFFF !important; color: #000000 !important; 
        border: 2px solid #D4AF37 !important; font-size: 18px !important; 
        text-align: center !important; height: 40px !important; width: 80px !important;
        font-weight: 900 !important;
    }
    .symmetry-bridge { color: #00FF00; font-size: 16px; font-weight: 900; border-bottom: 2px solid #00FF00; padding: 0 10px; }
    </style>
...
with cols[0]:
    ...
    draw_grid(st.session_state.get('v_nano_1', ""), "grid-light", "red")

with cols[1]:
    st.write("<div style='height:5px;'></div>", unsafe_allow_html=True)
    st.text_input("", placeholder="****", max_chars=4, key="v_nano_1", label_visibility="collapsed")
...
with cols[2]:
    ...
    draw_grid(st.session_state.get('v_nano_2', ""), "grid-light", "blue")
...
with cols[5]:
    st.write("<div style='height:5px;'></div>", unsafe_allow_html=True)
    st.text_input("", placeholder="****", max_chars=4, key="v_nano_2", label_visibility="collapsed")
    st.markdown("<div class='gold-pillar'></div>", unsafe_allow_html=True)
