...
# --- 2. THE BRANDING & DATE ANCHOR (TOP DECK) ---
...
with t_col2: # CENTER CALENDAR
    ...
    st.markdown(f"<div class='digital-calendar'>DATE: {curr_date}</div>", unsafe_allow_html=True)
with t_col3: # BLUE DATE NUMBERS
...
# --- 5. THE 4 GRIDS (SYMMETRY SENSORS) ---
