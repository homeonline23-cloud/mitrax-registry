...
st.markdown("""
    ...
    .stSuccess { font-weight: 900; font-size: 20px; border: 2px solid #D4AF37; color: #000000 !important; background-color: #D4AF37 !important; padding: 2px; }
...
# --- 4. THE VERTICAL DATE ANCHOR (STANDING UNDER RESULTS) ---
st.write("---")
