...
# --- 3. THE TEMPORAL ANCHOR (NEW SECTION FROM IMAGE) ---
st.write("---")
t_col1, t_col2, t_col3 = st.columns([1, 2, 1])

with t_col1: # LEFT RED
...
with t_col2: # CENTER CALENDAR
    current_date = datetime.now().strftime("%m/%d/%Y")
    st.markdown(f"<div class='digital-calendar'>DATE: {current_date}</div>", unsafe_allow_html=True)

with t_col3: # RIGHT BLUE
